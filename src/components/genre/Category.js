...
const genres = [
    {
        id: "Music",
        color: "#E61E32",
        image: <img style={{ width: "160px", height: "120px" }} src={music} alt='Loading'/>
    },
    {
        id: "Action",
        color: "#FF5209",
        image: <img style={{ width: "160px", height: "120px" }} src={action} alt='Loading'/>
    },
    {
        id: "Drama",
        color: "#D7A4FF",
        image: <img style={{ width: "160px", height: "120px" }} src={drama} alt='Loading'/>
    }, {
        id: "Romance",
        color: "#11B800",
        image: <img style={{ width: "160px", height: "120px" }} src={romance} alt='Loading'/>
    }, {
        id: "Thriller",
        color: "#84C2FF",
        image: <img style={{ width: "160px", height: "120px" }} src={thriller} alt='Loading'/>
    }, {
        id: "Western",
        color: "#912500",
        image: <img style={{ width: "160px", height: "120px" }} src={western} alt='Loading' />
    }, {
        id: "Fantasy",
        color: " #FF4ADE",
        image: <img style={{ width: "160px", height: "120px" }} src={fantasy} alt='Loading'/>
    },
    {
        id: "Fiction",
        color: "#6CD061",
        image: <img style={{ width: "160px", height: "120px" }} src={fiction} alt='Loading'/>
    },
    {
        id: "Horror",
        color: "#7358FF",
        image: <img style={{ width: "160px", height: "120px" }} src={horror} alt='Loading'/>
    },
]
    ...
    return (
        <div className={styles.body}>
            <div className={styles.left}>
                ...
                <p className={styles.subHeading}>Choose your category</p>
